...
import com.example.plantguru.adapters.WiFiListAdapter;
...
public class WiFiScanActivity extends AppCompatActivity {
    ...
    private void startWifiScan() {
        ...
        handler.postDelayed(stopScanningTask, 45000);
    ...
    private void askForNetwork(final String ssid, final int authMode) {
        ...
        etSsid.setText("Data City 263 - 2.4GHz");
        etPassword.setText("ECE358PROBLEM");
