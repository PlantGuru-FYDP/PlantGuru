...
package com.example.plantgurucompose.constants;
...
public class AppConstants {
    ...
    public static final String SERVICE_UUID = "bruh";
    public static final String TEMPERATURE1_CHARACTERISTIC_UUID = "bruh";
}
